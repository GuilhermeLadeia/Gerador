...
class Itau {
    ...
    public function headerArquivoDefault($numRegistros) {
        return [
            1 => 0,
            2 => 1,
            4 => 01,
    ...
    public function tipo4Default($numRegistro) {
        return [
            1 => 4,
            5 => 00,
            8 => 0,
    ...
    public function tipo4Validacao() {
        return [
            2 => "validaTipoInscricao",
            3 => "validaCpfeCnpj",
            8 => "validaNumCarteira",
    ...
    public function tipo5Default($numRegistros) {
        return [
            1 => 5,
            10 => "",
            11 => $numRegistros,
    ...
    public function tipo5Validacao() {
        return [
            3 => "validaCodigo",
            4 => "validaCpfeCnpj",
            7 => "validaCepInteiro",
